package net.aaronautic.distantvoid.entity.custom;
...
public class ShadowGolemEntity extends Animal {
    public final AnimationState idleAnimationState = new AnimationState();
    private int idleAnimationTimeout = 0;

    public ShadowGolemEntity(EntityType<? extends Animal> pEntityType, Level pLevel) {
    ...
    public AgeableMob getBreedOffspring(ServerLevel pLevel, AgeableMob pOtherParent) {
        return ModEntities.SHADOW_GOLEM.get().create(pLevel);
    }
